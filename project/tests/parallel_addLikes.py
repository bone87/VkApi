...
commands = [
    ...
    #  '--output', 'reports/likes/tmp/output_375292025693_Minsk_likes.xml',
    #  '--report', 'reports/likes/tmp/report_375292025693_Minsk_likes.html',
    #  '--log', 'reports/likes/tmp/log_375292025693_Minsk_likes', path_to_test1],
    # [path_to_pybot,
...
rebot(os.path.join(path_to_tests,           'reports/likes/tmp/output_375298681142_Minsk_likes.xml'),
      ...
      # 'c:/TeamCity/buildAgent/work/c5b3fb5b1ac0d88e/reports/likes/tmp/output_375292025693_Minsk_likes.xml',
