...
rebot(os.path.join(path_to_tests,           'reports/message/tmp/output_375298462344_Minsk_mes_31.xml'),
      ...
      report=os.path.join(path_to_tests,    'reports/message/report_send_birthday_message.html'),
      log=os.path.join(path_to_tests,       'reports/message/log_send_birthday_message.html'),
      xunit=os.path.join(path_to_tests,     'reports/message/robotxunit.xml'))
